...
- All changes to asset packaging logic should be made in the embedded Python script within action.yml.
...
This repository provides a composite GitHub Action that packages and prepares build artifacts for release.

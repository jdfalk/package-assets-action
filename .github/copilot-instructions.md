...
- This is a composite GitHub Action that embeds Python logic directly in
  action.yml.
- All changes to asset packaging logic should be made in the embedded Python
...
This repository provides a composite GitHub Action that packages and prepares
